 ...
 * Goto InDesign CS4 and run the script wordPressImport_v0_03.js from the Scripts Panel
 * 
 * See what happens!
 * 
...
#include "./metaScripts/vFFF_findChange_v0_01.js";
// in the old setupDoc are the sizes provided by the vFFF
//#include "vFFF_SetupDoc_v0_01.js";

// the is for a more basic document styling
// there will be changes in the paragraph and character styles to
#include "./metaScripts/vFFF_SetupDoc_A4.js";
//this is for cleaning the xml structure at the end
#include "./metaScripts/clear_XML_Structure.jsx"
...
function main() {
	...
	//this comes from 
	//untagAllxmlElements(myDocument);
